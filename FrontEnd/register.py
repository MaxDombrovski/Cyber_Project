...
class Register_Window1(tkinter.Toplevel, client):
    ...
    def __init__(self, parent):
        ...
        self.hats = ["player_assets/TopHat.png", "player_assets/Cap.png"]
        self.shirts = ["player_assets/WhiteShirt.png", "player_assets/Suit.png"]
        self.pants = ["player_assets/Jeans.png", "player_assets/Shorts.png"]
        self.shoes = ["player_assets/Sneakers.png", "player_assets/Crocs.png"]
    ...
    def submit(self):
        ...
        if not re.fullmatch(r'[^@]+@[^@]+\.[^@]+', self.email.get()):
            ...
            self.client.client_socket.send(str_insert.encode())
